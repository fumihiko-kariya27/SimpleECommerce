...
namespace SimpleECommerce.Migrations
{
    ...
    [Migration("20260421122445_AddCartLine")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleECommerce.Models.Shopping.CartLineModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimpleECommerce.Models.Shopping.CartLineModel", b =>
                {
                    ...
                    b.HasOne("SimpleECommerce.Models.Catalog.ProductModel", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId", "Category")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SimpleECommerce.Models.Stock.InventoryModel", b =>
                {
                    b.HasOne("SimpleECommerce.Models.Catalog.ProductModel", "Product")
                        .WithOne("Inventory")
                        .HasForeignKey("SimpleECommerce.Models.Stock.InventoryModel", "Id", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
